        ...
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route('register') }} " class="validate-form" name="form1">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="wrap-input100 validate-input">
                            <input type="text" name="telefone" id="telefone" class="form-control input-sm chat-input input100"
                                   title="telefone" required  placeholder="telefone">
                            <small id="guerraHelp" class="form-text text-muted text-center audiowide">Telefone</small>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100"><i class="fa fa-user pb-3" aria-hidden="true"></i></span>
                        </div>
                    </div>
                ...
                <div class="text-center p-t-20">
                    <a class="txt2" href="#">
                        <div class="footer text-white text-center">
                            <p>© 2020 BT - Banco de talento. Desenvolvido pelo: 3º SGT Thiago Pereira <strong>Dos Santos</strong></p>
                        </div>
                    </a>
                </div>
