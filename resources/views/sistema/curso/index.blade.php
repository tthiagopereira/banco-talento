                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h3><span class="audiowide">Gerenciamento de cursos <i class="icon-graduation"></i> </span></h3>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <table id="example" class="display  "style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">Tipo do curso</th>
                                        ...
                                        @foreach($register as $registro)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @can('view',\App\User::class)
                                                        <a href="{{route('curso.edit',$registro->id)}}" data-toggle="tooltip" data-placement="top" title="Editar" class="link"><i class="icon-pencil"></i></a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{route('curso.destroy',$registro->id)}}" type="button" class="btn btn-danger">Excluir</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
