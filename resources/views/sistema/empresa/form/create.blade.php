                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h3><span class="audiowide"><i class="fa fa-puzzle-piece"></i> Nova empresa </span></h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row ">
                                <div class="container-fluid">
                                    ...
                                    <div class="card-body">
                                        <form action="{{route('empresa.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal was-validated">
                                            {{ csrf_field() }}
